"""
train_single_k_256.py — Train one K value (Stage A + B) at 256×256 with checkpoint resume

Usage:
    python train_single_k_256.py 128
    python train_single_k_256.py 256
    python train_single_k_256.py 512
    python train_single_k_256.py 1024
...
Hardware: RTX 5080 16GB
  ...
  If Stage B hits OOM: reduce BATCH_SIZE to 1, increase GRAD_ACCUM_STEPS to 8
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python train_single_k_256.py <K>")
        sys.exit(1)
